  ...
  <body>
    ...
    <main id="main" class="main">
      ...
      <div class="container shadow p-4">
        <form action="${pageContext.request.contextPath}/admin/danhsachsinhvien/sua" method="post" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="form-group col-md-6 mb-3">
              <label>Họ tên</label>
              <input type="text" class="form-control" name="HoTenSV" value="${sv.HoTenSV}" />
              <c:if test="${not empty loiHoTenSV}"><small class="text-danger">${loiHoTenSV}</small></c:if>
            </div>
            <div class="form-group col-md-6 mb-3">
              <label>Ngày sinh</label>
              <input type="date" class="form-control" name="NgaySinhSV" value="${sv.NgaySinhSV}" />
            ...
            <div class="form-group col-md-6 mb-3">
              ...
              <input type="text" class="form-control" name="QueQuanSV" value="${sv.QueQuanSV}" />
              <c:if test="${not empty loiQueQuanSV}"><small class="text-danger">${loiQueQuanSV}</small></c:if>
            </div>
            <div class="form-group col-md-6 mb-3">
              <label>Email</label>
              <input type="email" class="form-control" name="EmailSV" value="${sv.EmailSV}" />
            ...
            <div class="form-group col-md-6 mb-3">
              ...
              <select name="MaLop" class="form-select">
                ...
                <c:forEach var="lop" items="${danhSachLop}">
                  <option value="${lop.MaLop}" <c:if test="${sv.MaLop == lop.MaLop}">selected</c:if>>${lop.TenLop}</option>
                </c:forEach>
              </select>
            ...
            <div class="form-group col-md-6 mb-3">
              ...
              <input type="text" class="form-control" name="SoDienThoaiSV" value="${sv.SoDienThoaiSV}" />
            ...
            <div class="form-group col-md-6 mb-3">
              ...
              <c:if test="${not empty loiAnhSV}"><small class="text-danger">${loiAnhSV}</small></c:if>
            </div>
          </div>
